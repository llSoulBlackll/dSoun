...
import com.soulblack.dsoun.adapters.SearchAdapter;
...
import com.soulblack.dsoun.provider.SearchHistory;
...
public class SearchActivity extends BaseThemedActivity implements SearchView.OnQueryTextListener, View.OnTouchListener {
    ...
    @Nullable
    private AsyncTask<String, Void, ArrayList<Object>> mSearchTask = null;
